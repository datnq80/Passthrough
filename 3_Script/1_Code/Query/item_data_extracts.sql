SELECT 
	...
	,seller.tax_class
	,CONCAT('"',soaddress.city,'"') shipping_city
	,CONCAT('"',soaddress.customer_address_region_name,'"') shipping_region
...
WHERE (rts.created_at between '2015-06-01' and '2015-06-30')