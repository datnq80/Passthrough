...
if(!dir.exists(file.path(outputFodler,venture))){
    dir.create(file.path(outputFodler,venture))
}
...
write.csv(PassthroughData, file = file.path(outputFodler,venture,paste0(ventureShort,"_PassthroughData.csv")),
          row.names = FALSE)
